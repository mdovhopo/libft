...
SRC_C = 	$(addprefix $(MATH_SRC_DIR)/,	ft_map.c \
								ft_vectors.c \
								ft_math_small_fnc.c \
								ft_solve_quadric.c ) \
			$(addprefix $(STRING_SRC_DIR)/, ft_isalpha.c \
								ft_isdigit.c \
								ft_isalnum.c \
								ft_isascii.c \
								ft_isprint.c \
								...
								ft_strncmp.c \
								get_next_line.c ) \
				$(addprefix $(PRINT_SRC_DIR)/,	ft_putchar_fd.c \
								ft_show_binary.c \
								ft_make_coffee.c \
								ft_putchar.c \
								ft_putstr.c \
								...
								ft_putendl_fd.c \
								ft_putnbr_fd.c ) \
				$(addprefix $(FT_PRINTF_SRC_DIR)/, ft_printf.c \
								print_format.c \
								parse_format.c \
								handle_token.c \
								utils.c \
